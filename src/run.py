...
def train_timm(args):
    ...
    model = train(model, train_loader, val_loader, 
                  args.optim, args.learning_rate, args.loss_fn,
    ...
    # (6) start evaluating
    preds, targets = evaluation(model, eval_loader, args.exp_dir, args.cloud, args.cloud_dir, args.bucket)
...
def get_embeddings(args):
    ...
    try:
        pqt_path = '{}/{}_{}_{}_embeddings.pqt'.format(args.exp_dir, args.dataset, args.model_type, args.embedding_type)
        ...
        csv_path = '{}/{}_{}_{}_embeddings.csv'.format(args.exp_dir, args.dataset, args.model_type, args.embedding_type)
...
def main():
    ...
    parser.add_argument("--trained_mdl_path", default="gs://ml-e107-phi-shared-aif-us-p/m144443/checkpoints/wav2vec2-base-960h", help="specify path to trained model")
    ...
    #ecapa-tdnn specific
    parser.add_argument("--version", default=50, type=int)
